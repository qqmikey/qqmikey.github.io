                                ...
                                <div key={i}>
                                    <Card className={classes.card}>
                                        ...
                                        <CardActions className={classes.actions} disableActionSpacing>
                                            {
                                                item.chips !== undefined && item.chips.map((chip, i) => {
                                                   return (
                                        ...
                                        <Collapse in={item.expanded} timeout="auto" unmountOnExit>
                                            <CardContent>
                                                ...
                                                <Typography paragraph>
                                                    ...
                                                    tomatoes, onion,
                                                    salt and pepper, and cook, stirring often until thickened and
                                                    fragrant, about 10
                                                ...
                                                <Typography paragraph>
                                                    ...
                                                    peppers, and
                                                    cook without stirring, until most of the liquid is absorbed, 15 to
                                                    18 minutes.
                                                    Reduce heat to medium-low, add reserved shrimp and mussels, tucking
                                                    them down into
                                                    the rice, and cook again without stirring, until mussels have opened
                                                    and rice is
